...
function init() {
    //if we have 'shader' in the url as a query parameter, then we're editing on the filesystem and should return.
    if (new URLSearchParams(window.location.search).has('shader')) return
