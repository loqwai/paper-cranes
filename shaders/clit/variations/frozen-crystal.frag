...
// Frozen Crystal — Grand smooth forms, glacial zoom, heavy persistent trails

#define A (1.2 + spectralCentroidSlope * spectralCentroidRSquared * 0.32 + spectralCentroidZScore * 0.06 + 0.01 * sin(iTime * 0.025))
#define B (0.65 + energySlope * energyRSquared * 0.2 + energyZScore * 0.024 + 0.015 * sin(iTime * 0.0315))
...
void mainImage(out vec4 P, vec2 V) {
    ...
    float color_phase = 4.0 + spectralSpreadNormalized * 2.6;
