...
#define variety energyMax / 10. + (time / 1000.)
// Map PROBEs to knobs initially
#define PROBE_A (time/10. + bassMax) // Base rotation
#define PROBE_B (mapValue(pitchClassMedian,0.,1.,0.1,.32)) // Color intensity
#define PROBE_C (variety) // Pattern scale
#define PROBE_D (1. - spectralCentroidMedian) // Fractal detail
#define PROBE_E (1.) // Color blend
#define PROBE_F (energyMax) // Pattern evolution
#define PROBE_G (0.1)
#define PROBE_H spectralRoughnessMax + time/1000.
