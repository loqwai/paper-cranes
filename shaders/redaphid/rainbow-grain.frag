//https://visuals.beadfamous.com/edit?knob_7=0.119&knob_7.min=0.1&knob_7.max=0.2&knob_8=0.276&knob_8.min=0&knob_8.max=1&knob_9=-0.236&knob_9.min=-10&knob_9.max=10&knob_14=0.882&knob_14.min=0&knob_14.max=1&knob_6=0.165&knob_6.min=0&knob_6.max=1&knob_2=1&knob_2.min=0&knob_2.max=1&knob_5=0.583&knob_5.min=0&knob_5.max=1&knob_16=0.504&knob_16.min=0&knob_16.max=1&knob_15=0.205&knob_15.min=0&knob_15.max=1&knob_13=1.701&knob_13.min=0&knob_13.max=3&knob_4=0.055&knob_4.min=0&knob_4.max=1&knob_1=0&knob_1.min=0&knob_1.max=1&knob_12=0.543&knob_12.min=0&knob_12.max=1&knob_11=0.638&knob_11.min=0&knob_11.max=1&knob_3=0.189&knob_3.min=0&knob_3.max=1&knob_10=0.354&knob_10.min=0&knob_10.max=1
...
float noise(vec2 p) {
    ...
    d = mix(d, granular(random(p, knob_9)+sin(time), 2.),knob_16);
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    vec3 olc = rgb2hsl(getLastFrameColor(sin(uv*knob_15)).rgb);
    vec3 lastColor = rgb2hsl(getLastFrameColor(sin(olc).xy).rgb);

    // Create flowing pattern
    float t = iTime * FLOW_SPEED * knob_13;
