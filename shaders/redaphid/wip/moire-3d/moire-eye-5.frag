// @fullscreen: true
// @mobile: false
// moire-eye-5 — checkpoint fork of moire-eye-4 (full-frame iris + curling fractal TENDRILS +
// pupil TUNNEL + clean de-noised anatomy + spectral audio map + TREND/Rslopes). Snapshot taken
// as a stable keeper of the full-frame composition before further experimentation.
//
// ============================================================================
...
void mainImage( out vec4 C, in vec2 U )
{
    ...
    float curl  = (ang + wave*0.4)*armN + er*twist*6.2832 - iTime*(0.4 + energyNormalized*0.8); // spiral + bend + rotate
    ...
    outc += (c*2.2 + vec3(0.12, 0.18, 0.30)) * tendril * tendZone * (0.7 + bassNormalized*0.9*REACT);
