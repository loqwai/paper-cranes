// @fullscreen: true
// @mobile: false
// moire-eye-3 — fork of moire-eye-1 (the calmed, flicker-fixed eye) with a RICH spectral
// audio map. eye-1 only used the raw bands (bass/mids/treble/energy) at tiny coefficients, so
// the music was invisible. eye-3 drives a VARIETY of independent spectral features AND their
// statistical variations (normalized / zScore / slope / rSquared) into distinct parts of the
// eye, while keeping the temporal frame-blend so it breathes with the music instead of strobing.
//
// ============================================================================
