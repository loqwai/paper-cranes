...
```
http://localhost:6969/jam.html?shader=redaphid/wip/taco-kandi/6&controller=taco-kandi&image=images/taco.png&audio=tab&knob_1=0.551&knob_2=0&knob_3=0.528&knob_4=0&knob_5=0.26&knob_6=0.22&knob_7=0.378&knob_8=0.37&knob_9=0.087&knob_10=0.024&knob_11=0.795&knob_12=0.441&knob_13=0&knob_14=0.74&knob_15=0.906&knob_16=0.472
```
...
Branded VJ set tomorrow for filibertos. Logo recognition is sacred (sharp ink overlay guards it). All feedback paths are mathematically banding-safe (bounded mix() blends).
