...
Forked from `the-coat-22` on **2026-04-27** mid-`/vj` run (iter 66) during *Comments (feat. KE) – Claude VonStroke, ZDS, KE*. Captures the "inky-dramatic chaos drop" knob config the user dialed in for chaos-bright moments — distinct from -15's "painterly groove."
...
```
http://localhost:56619/jam.html?shader=redaphid/wip/the-coat-fur-coat/the-coat-23&controller=the-coat&knob_1=0&knob_2=0.512&knob_3=0.535&knob_4=0.386&knob_5=0.331&knob_6=0.591&knob_7=0.866&knob_8=0.488&knob_9=0.764&knob_10=1&knob_11=0.378&knob_12=1&knob_13=0&knob_14=0.331&knob_15=0.394
```
