// @favorite: true
// @fullscreen: true
// @name: plasma event horizon 2
// @tags: black-hole, radial, event-horizon, oklch
//
// plasma-event-horizon/2.frag — forked from .../1.frag at iter 14 of /vibej run.
// Captures post-fix state: continuous disk (no interior black voids), additive
// raymarch accumulator, evolving fractal w/ tanh-clamped fold sum, capped lensing
// twist. 13 wired knobs baked into the preset. See 2.md for details.
//
