// @favorite: true
// @fullscreen: true
// @name: plasma event horizon 3
// @tags: black-hole, radial, event-horizon, oklch
//
// plasma-event-horizon/3.frag — forked from .../2.frag during deep warm-bass
// dr-fresch corner pocket. User had cranked: k1 SHAPE_TWIST=1 (max spin),
// k7 WAVE_STRENGTH=1 (max fold), k11 DRIFT_SPEED=1 (max drift), k12=1, k13=0.976,
// k14=0.835. The pink+orange disk preset captured visually for future iters to
// build on. See 3.md for the baked preset.
//
