...
//http://localhost:6969?shader=redaphid%2Firis%2F1&controller=dodeca-bloom&knob_1=0.717&knob_1.min=0&knob_1.max=1&knob_3=0.449&knob_3.min=0&knob_3.max=1&audio=tab&knob_5=0.26&knob_5.min=0&knob_5.max=1&knob_7=0.551&knob_7.min=0&knob_7.max=1&knob_4=0.49&knob_4.min=0&knob_4.max=1&knob_2=0.638&knob_2.min=0&knob_2.max=1&knob_6=0.764&knob_6.min=0&knob_6.max=1&knob_9=1&knob_9.min=0&knob_9.max=1&knob_10=0.906&knob_10.min=0&knob_10.max=1&knob_11=0.291&knob_11.min=0&knob_11.max=1&knob_12=0.559&knob_12.min=0&knob_12.max=1&knob_13=0.52&knob_13.min=0&knob_13.max=1&knob_14=0.921&knob_14.min=0&knob_14.max=1&knob_15=0.433&knob_15.min=0&knob_15.max=1&knob_16=0.134&knob_16.min=0&knob_16.max=1&knob_8=0.748&knob_8.min=0&knob_8.max=1
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    // === GAZE (knob_12 X, knob_9 Y, knob_19 strength) ===
    ...
    float GAZE_STR = knob_19 * 0.50; // 0..0.50 max travel in normalized screen
    ...
    float irisR = rr;
    float fiber = d * mix(10.0, 46.0, knob_3);
    ...
    // the limbal+outer band (irisR > 0.4), independent of audio. Together with knob_4 (base
    ...
    float chromaScale = mix(0.65, 1.30, knob_4)
    ...
    // Pure RGB add (not L mod), tight ~1.5% radius, gated by knob_19 and by pupil proximity
