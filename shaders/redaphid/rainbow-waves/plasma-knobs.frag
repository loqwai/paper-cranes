...
#define COLOR_MIX_FACTOR (0.3 + knob_19 * 0.7)
#define COLOR_INTENSITY (0.3 + knob_20 * 0.7)
#define COLOR_SHIFT_SPEED (0.5 + knob_71 * 1.5)
#define SATURATION_BASE (0.7 + knob_72 * 0.3)
#define LIGHTNESS_FACTOR (0.2 + knob_23 * 0.6)
