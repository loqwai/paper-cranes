...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    if (fur_fractal_amt > 0.01) {
        ...
        // BRACELET-SHADOW: strands almost invisible — only the brightest fibers catch faint blue rim
        vec3 strand_col = mix(fur_col, hsl2rgb(vec3(0.58, 0.15, 0.30)), 0.10 + strand * 0.10);
