...
// @mobile: true
// @tags: the-coat
// the-coat / balanced-punch: punchy and balanced (first pinwheel-respecting fork)
// Source: the-coat-20 (Wanna See You - SIDEPIECE)
//
// URL: http://localhost:6969/jam.html?shader=redaphid/the-coat/balanced-punch&controller=the-coat&audio=tab
//
// Knobs:
