...
// @mobile: true
// @tags: the-coat
// the-coat / baseline: full Hypnosound feature coverage, neutral starting point
// Source: the-coat-14 (current main)
//
// URL: http://localhost:6969/jam.html?shader=redaphid/the-coat/baseline&controller=the-coat&audio=tab
//
// Knobs:
