...
// @mobile: true
// @tags: the-coat
// the-coat / foggy-figure: atmospheric fog with recessed eyes, looser framing
// Source: the-coat-21 (Bone Breaker - Dr. Fresch)
//
// URL: http://localhost:6969/jam.html?shader=redaphid/the-coat/foggy-figure&controller=the-coat&audio=tab
//
// Knobs:
