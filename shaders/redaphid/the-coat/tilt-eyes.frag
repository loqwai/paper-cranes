...
// @mobile: true
// @tags: the-coat
// the-coat / tilt-eyes: camera tilt swagger with eye motif
// Source: the-coat-19 (All Eyez On Me - Capozzi)
//
// URL: http://localhost:6969/jam.html?shader=redaphid/the-coat/tilt-eyes&controller=the-coat&audio=tab
//
// Knobs:
