...
// @mobile: true
// @tags: the-coat
// the-coat / chaos-drop: inky-dramatic chaos drop with extreme bass amplifier
// Source: the-coat-23 (Comments - Claude VonStroke)
//
// URL: http://localhost:6969/jam.html?shader=redaphid/the-coat/chaos-drop&controller=the-coat&audio=tab
//
// Knobs:
