...
// @fullscreen: true
// @name: taco demo 1
// @tags: taco, kandi, plasma, branded, region-tagged, unique
//
// Taco taco visualization — demo build derived from taco-kandi/13.
// Region-tagged mask: SHELL (red) gets a wooli-style seeded Julia fractal,
// FILLING (green) gets the plasma raymarch + aurora ribbons, INK (black) is
// legitimately black for logo discernability, OUTSIDE is the cosmic void.
// Trend-dominant kick detection (R²-weighted slopes) — no `beat` uniform.
// Plasma palette locked: magenta mathematically unreachable.
//
// Per-device uniqueness for kandi bracelets via seed/seed2/seed3/seed4.
// Each device shows a different fractal family in the shell + subtle palette
// tilt + photon-ring hue offset, all bounded to stay in plasma family.
//
// KNOBS:
...
// http://localhost:6969/?shader=redaphid/taco/demo-1&image=images/taco.png&controller=taco-kandi
// Tab-audio mode (Spotify/SoundCloud — Chrome desktop):
// http://localhost:6969/?shader=redaphid/taco/demo-1&image=images/taco.png&controller=taco-kandi&audio=tab
// Live jam editor:
// http://localhost:6969/jam.html?shader=redaphid/taco/demo-1&image=images/taco.png&controller=taco-kandi&audio=tab
// Seeded variants (each phone gets a unique look):
// http://localhost:6969/?shader=redaphid/taco/demo-1&image=images/taco.png&controller=taco-kandi&seed=0.618&seed2=0.755&seed3=0.892&seed4=0.029
// http://localhost:6969/?shader=redaphid/taco/demo-1&image=images/taco.png&controller=taco-kandi&seed=0.236&seed2=0.373&seed3=0.51&seed4=0.647
// http://localhost:6969/?shader=redaphid/taco/demo-1&image=images/taco.png&controller=taco-kandi&seed=0.854&seed2=0.991&seed3=0.128&seed4=0.265
