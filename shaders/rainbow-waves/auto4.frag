// @fullscreen: true
//https://visuals.beadfamous.com/edit?knob_1.min=-1&knob_1.max=1&knob_2=0.24&knob_2.min=-1&knob_2.max=1&knob_5=0.608&knob_5.min=-4.6&knob_5.max=1&knob_6=3.996&knob_6.min=0&knob_6.max=14.8&knob_7=0.75&knob_7.min=0&knob_7.max=3&knob_8=0.436&knob_8.min=0.1&knob_8.max=2.5&knob_10=0.77&knob_10.min=0&knob_10.max=1&knob_9=2.8&knob_9.min=0&knob_9.max=2.8&knob_11=0.379&knob_11.min=0.1&knob_11.max=3.2&knob_12=8.911&knob_12.min=0.1&knob_12.max=10&knob_13=0.73&knob_13.min=0&knob_13.max=1&knob_1=0.1&fullscreen=true
// Constants
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    // prevColor = getLastFrameColor(prevColor.yx);
    ...
    if(ph.y < 0.1 || ph.z > 0.8) {
        fragColor = sin(vec4(color/1.01, 1.));
        return;
    }
    if(ch.y < 0.1 || ch.z > mix(0.7, 0.9, animateEaseInQuad((time+0.11)/1000.))) {
        fragColor.rgb = sin(prevColor.rgb/1.01);
        return;
    }
