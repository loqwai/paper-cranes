...
// @fullscreen: true
// @name: magic peach
// @tags: black-hole, radial, event-horizon, oklch, peach
//
// magic-peach.frag — captured from a /vibej run on 2026-05-02 during
// *PressureGENESI – Laherte*. A pink/magenta core with warm peach/orange accretion
// glow, built up across 14 iterations of live-VJ on the canonical plasma.frag and
// then forked into shaders/claude/wip/plasma-event-horizon/{1,2,3}. This is the
// named-keeper from /3 — same code, same preset, just named for the look.
//
