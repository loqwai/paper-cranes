...
#define PROBE_D (energyNormalized )     // Controls color intensity based on energy (0.7-1.2)
...
void mainImage(out vec4 fragColor, in vec2 fragCoord){
    ...
    float spiralSpeed = mix(0.5, 2.0, PROBE_B/2.);
    float spiralThickness = mix(0.01, 0.3, PROBE_E); // Slightly thinner for more hypnotic look
