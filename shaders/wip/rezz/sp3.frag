//http://localhost:6969/edit.html?knob_71=0.78&knob_71.min=0&knob_71.max=1&knob_72=0.11&knob_72.min=0&knob_72.max=1&knob_73=0.06&knob_73.min=0&knob_73.max=1&knob_74=0.54&knob_74.min=0&knob_74.max=1&knob_75=0.32&knob_75.min=-0.7&knob_75.max=1&knob_76=0.55&knob_76.min=0&knob_76.max=1&knob_77=0.54&knob_77.min=0&knob_77.max=1&knob_78=0.2&knob_78.min=0&knob_78.max=1&knob_79=0.71&knob_79.min=0&knob_79.max=1&knob_19=1&knob_19.min=0&knob_19.max=1&knob_14=0&knob_14.min=0&knob_14.max=1&image=images%5Crezz-full-lips-cropped.png&knob_22=1&knob_22.min=0&knob_22.max=1&knob_21=0.543&knob_21.min=0&knob_21.max=1&knob_20=0.071&knob_20.min=0&knob_20.max=1&knob_18=0.37&knob_18.min=0&knob_18.max=1&knob_11=0.055&knob_11.min=0&knob_11.max=1&knob_15=0.268&knob_15.min=0&knob_15.max=1&knob_16=0.197&knob_16.min=0&knob_16.max=1&knob_3=0.425&knob_3.min=0&knob_3.max=1&knob_10=0&knob_10.min=0&knob_10.max=1&knob_17=0.331&knob_17.min=0&knob_17.max=1&knob_4=0.63&knob_4.min=0&knob_4.max=1&knob_5=1&knob_5.min=0&knob_5.max=1&knob_6=0.874&knob_6.min=0&knob_6.max=1&knob_7=0.646&knob_7.min=0&knob_7.max=1&knob_8=1&knob_8.min=0&knob_8.max=1&knob_9=0&knob_9.min=0&knob_9.max=1&knob_60=0.567&knob_60.min=0&knob_60.max=1&knob_34=0.425&knob_34.min=0&knob_34.max=1&knob_30=0.394&knob_30.min=0&knob_30.max=1&knob_37=0.575&knob_37.min=0&knob_37.max=1&knob_40=0.52&knob_40.min=0&knob_40.max=1&knob_41=0.52&knob_41.min=0&knob_41.max=1&knob_43=0.409&knob_43.min=0&knob_43.max=1&knob_47=0.654&knob_47.min=0&knob_47.max=1&knob_31=0.134&knob_31.min=0&knob_31.max=1&knob_36=0.276&knob_36.min=0&knob_36.max=1&knob_35=0&knob_35.min=0&knob_35.max=1
...
#define USE_KNOBS 1
  ...
  // Other Visual Effects [Knobs 8-9, 75]
  ...
  #define PROBE_G (spectralCentroidNormalized / 2.0)      // Balance: Spiral vs Fractal
  #define PROBE_H (spectralEntropyNormalized / 100.0)     // BG Warp Intensity
  #define RECURSIVE_SCALE_AMOUNT (spectralCrestNormalized)      // Recursive Scale Intensity
  ...
  // --- Other Visual Effects & Reactivity --- [Knobs 8-9, 30-33, 75]
  #define PROBE_D (knob_9)         // Color intensity and variation
  #define RECURSIVE_ITERATIONS (knob_8 * 3.0 + 1.0)
  #define DISTORTION_DIRECTIONALITY (0.)
  #define TIME_SCALE (knob_75 * 0.2 + 0.01)
  // Reactive Parameters Mapped to Knobs:
  #define PROBE_G (knob_30 * 0.5)                         // Balance: Spiral vs Fractal
  #define PROBE_H (knob_31 * 0.01)                        // BG Warp Intensity
  #define RECURSIVE_SCALE_AMOUNT (knob_32)                   // Recursive Scale Intensity
  ...
  //   [30-33]: Reactive Params (Balance, Warp, Scale Amount, Scale Factor) (4)
  //   [71-74]: Eye/Spiral Distortion/Fractal (4)
  //   [75]:    Time Scale (1)
  // Available Knobs: 34-37, 40-41, 43-47, 60, 76-79 (16 total)
#endif
