...
## Status
Live-set starter. Forked from the-coat-3 with full 15-knob layout wired from the start. Lightning / cosmic shockwave / scan-line pulled pre-session. Cron 388f588d firing every minute. User is DJing + twisting knobs live.
