...
## Forks
- `the-coat-22 ← the-coat-14` (iter 64, 2026-04-27): live painterly-groove preset captured. Bakes 27 ticks of -14 refinement (iters 38-64) including 6-system pitch_change subscription, async shader compile, Z-TRAIN/EMBER RISE/STEP RIPPLE/GROOVE BREATH motifs, 4-channel eye system, RIM_BOOST chaos+energyZ+zoom+pitch_change extensions, WARM HEARTH HUE_BASE-link + widened energy gate, nebula warm-shift + star occlusion. Knob preset bakeline in `the-coat-22.md`.
- `the-coat-23 ← the-coat-22` (iter 66, 2026-04-27): "inky-dramatic chaos drop" preset captured during *Comments (feat. KE) – Claude VonStroke*. Includes the iter-65 Z-TRAIN extreme-bass amplifier + iter-66 chaotic-bright eye coefficient bump. /vj run continues on -16 from iter 67. See `the-coat-23-cool-moments.md`.
