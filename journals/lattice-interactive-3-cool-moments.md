...
- [ ] ~21:55 (arc≈0.85): whiteish + hueMix.red check. Ceiling 0.90; fallback 0.85 if whiteish > 0.01. At arc 1.0 (~22:05) take a full 8-frame set as the 'hypercolor landed' record.
...
## History of changes
- iter22: R&D C4 tunnel rush grit — feedback offset gains kickExcess 0.012, flux 0.008, roughness 0.006 on top of iter14's 0.006+0.022*bassPulse. Trail-offset lane only.
